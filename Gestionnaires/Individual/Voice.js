class Voice{
    constructor(voice){
        ...
        this.channel = voice.channel ? voice.channel : null
        this.user_id = voice.user_id
        this.member = voice.member ? voice.member : null
        this.user = voice.user ? voice.user : null
        this.session_id = voice.session_id
        this.deaf = voice.deaf ? voice.deaf : false
        this.mute = voice.mute ? voice.mute : false
        this.self_deaf = voice.self_deaf ? voice.self_deaf : false
        this.self_mute = voice.self_mute ? voice.self_mute : false
        this.self_stream = voice.self_stream ? voice.self_stream : false
        this.self_video = voice.self_video ? voice.self_video : false
