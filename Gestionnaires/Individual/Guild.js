...
class Guild extends Base{
    constructor(guild, bot){
        ...
        this.roles = (new Roles(bot, this.id)).__addMultiple(guild.roles.map(el => { return {...el, guild: this, guild_id: this.id}}))
        this.emojis = (new Emojis(bot, this.id)).__addMultiple(guild.emojis.map(el => { return {...el, guild: this, guild_id: this.id}}))
        this.stickers = (new Stickers(bot, this.id)).__addMultiple(guild.stickers.map(el => { return {...el, guild: this, guild_id: this.id}}))
        this.presences = (new Presences(bot, this.id)).__addMultiple(guild.presences.map(el => { return {...el, guild: this, guild_id: this.id}}))
        this.channels = (new Channels(bot, this.id)).__addMultiple(guild.channels.map(el => { return {...el, guild: this, guild_id: this.id}}))
        this.stage_instances = (new StageInstances(bot, this.id)).__addMultiple(guild.stage_instances.map(el => { return {...el, guild: this, guild_id: this.id}}))
        this.guild_scheduled_events = (new Events(bot, this.id)).__addMultiple(guild.guild_scheduled_events.map(el => { return {...el, guild: this, guild_id: this.id}}))
        this.members = (new Members(bot, this.id)).__addMultiple(guild.members.map(el => { return {...el, guild: this, guild_id: this.id}}))
        this.owner = this.members.get(this.owner_id)
        this.threads = (new Threads(bot, this.id)).__addMultiple(guild.threads.map(el => { return {...el, guild: this, guild_id: this.id}}))
        this.voice_states = (new Voices(bot, this.id)).__addMultiple(guild.voice_states.map(el => { return {...el, guild: this, guild_id: this.id}}))
