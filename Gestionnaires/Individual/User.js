class User{
    constructor(user, bot){
        ...
        this.bot = user.bot ? user.bot : false
        this.system = user.system ? user.system : null
        this.mfa_enabled = user.mfa_enabled ? user.mfa_enabled : false
        this.banner = user.banner ? user.banner : null
        this.accent_color = user.accent_color ? user.accent_color : null
        this.locale = user.locale
        this.verified = user.verified ? user.verified : false
        this.email = user.email ?  user.email : null
        this.flags = user.flags ? user.flags : 0
        this.premium_type = user.premium_type ?  user.premium_type : null
        this.public_flags = user.public_flags ? user.public_flags : null
        this.dm = null
