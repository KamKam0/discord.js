class Channel{
    ...
    send(options){
        return new Promise(async (resolve, reject) => {
            ...
            .catch(err => {
                let er = new Error("Une erreur s'est produite lors de la requête - send, channel10")
                er.content = err
                reject(er)
            })
    ...
    fetchmessages(limit){
        return new Promise(async (resolve, reject) => {
            ...
            .catch(err => {
                let er = new Error("Une erreur s'est produite lors de la requête - fetchmessages, channel10")
                er.content = err
                reject(er)
            })
            .then(datas => { return resolve(datas)})
    ...
    fetchmessage(ID){
        return new Promise(async (resolve, reject) => {
            ...
            .catch(err => {
                let er = new Error("Une erreur s'est produite lors de la requête - fetchmessage, channel10")
                er.content = err
                reject(er)
            })
            .then(datas => { return resolve(datas)})
    ...
    edit(options){
        return new Promise(async (resolve, reject) => {
            ...
            .catch(err => {
                let er = new Error("Une erreur s'est produite lors de la requête - edit, channel10")
                er.content = err
                reject(er)
            })
            .then(datas => { return resolve(datas)})
    ...
    bulkdelete(number){
        return new Promise(async (resolve, reject) => {
            ...
            .catch(err => {
                let er = new Error("Une erreur s'est produite lors de la requête - bulkdelete, channel10 fetch")
                er.content = err
                reject(er)
            })
            .then(datas => {
                ...
                .catch(err => {
                    let er = new Error("Une erreur s'est produite lors de la requête - bulkdete, channel10")
                    er.content = err
                    reject(er)
                })
    ...
    getinvites(){
        return new Promise(async (resolve, reject) => {
            ...
            .catch(err => {
                let er = new Error("Une erreur s'est produite lors de la requête - getinvites, channel10")
                er.content = err
                reject(er)
            })
            .then(datas => { return resolve(datas)})
    ...
    createinvites(){
        return new Promise(async (resolve, reject) => {
            ...
            .catch(err => {
                let er = new Error("Une erreur s'est produite lors de la requête - createinvites, channel10")
                er.content = err
                reject(er)
            })
            .then(datas => { return resolve(datas)})
    ...
    editpermissions(overwrites){
        return new Promise(async (resolve, reject) => {
            ...
            .catch(err => {
                let er = new Error("Une erreur s'est produite lors de la requête - editpermissions, channel10")
                er.content = err
                reject(er)
            })
            .then(datas => { return resolve(datas)})
    ...
    deletepermissions(overwrites){
        return new Promise(async (resolve, reject) => {
            ...
            .catch(err => {
                let er = new Error("Une erreur s'est produite lors de la requête - deletepermissions, channel10")
                er.content = err
                reject(er)
            })
            .then(datas => { return resolve(datas)})
    ...
    follownewsChannel(targetid){
        return new Promise(async (resolve, reject) => {
            ...
            .catch(err => {
                let er = new Error("Une erreur s'est produite lors de la requête - follownewschannel, channel10")
                er.content = err
                reject(er)
            })
            .then(datas => { return resolve(datas)})
    ...
    getpins(){
        return new Promise(async (resolve, reject) => {
            ...
            .catch(err => {
                let er = new Error("Une erreur s'est produite lors de la requête - getpins, channel10")
                er.content = err
                reject(er)
            })
            .then(datas => { return resolve(datas)})
    ...
    triggertyping(){
        return new Promise(async (resolve, reject) => {
            ...
            .catch(err => {
                let er = new Error("Une erreur s'est produite lors de la requête - triggertyping, channel10")
                er.content = err
                reject(er)
            })
            .then(datas => { return resolve(datas)})
