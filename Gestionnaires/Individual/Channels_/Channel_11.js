class Channel{
    ...
    Modify_Datas(guild){
        ...
        tocheck.forEach(e => { if(this[e[0]] !== e[1]) this[e[0]] = e[1] })
        return this
    }
    ...
    send(options){
        return new Promise(async (resolve, reject) => {
            ...
            .catch(err => {
                let er = new Error("Une erreur s'est produite lors de la requête - send, channel11")
                er.content = err
                reject(er)
            })
    ...
    fetchmessages(limit){
        return new Promise(async (resolve, reject) => {
            ...
            .catch(err => {
                let er = new Error("Une erreur s'est produite lors de la requête - fetchmessages, channel11")
                er.content = err
                reject(er)
            })
            .then(datas => { return resolve(datas)})
    ...
    fetchmessage(ID){
        return new Promise(async (resolve, reject) => {
            ...
            .catch(err => {
                let er = new Error("Une erreur s'est produite lors de la requête - fetchmessage, channel11")
                er.content = err
                reject(er)
            })
            .then(datas => { return resolve(datas)})
    ...
    edit(options){
        return new Promise(async (resolve, reject) => {
            ...
            .catch(err => {
                let er = new Error("Une erreur s'est produite lors de la requête - edit, channel11")
                er.content = err
                reject(er)
            })
            .then(datas => { return resolve(datas)})
    ...
    bulkdelete(number){
        return new Promise(async (resolve, reject) => {
            ...
            .catch(err => {
                let er = new Error("Une erreur s'est produite lors de la requête - bulkdelete, channel11 fetch")
                er.content = err
                reject(er)
            })
            .then(datas => {
                ...
                .catch(err => {
                    let er = new Error("Une erreur s'est produite lors de la requête - bulkdete, channel11")
                    er.content = err
                    reject(er)
                })
    ...
    getinvites(){
        return new Promise(async (resolve, reject) => {
            ...
            .catch(err => {
                let er = new Error("Une erreur s'est produite lors de la requête - getinvites, channel11")
                er.content = err
                reject(er)
            })
            .then(datas => { return resolve(datas)})
    ...
    createinvites(){
        return new Promise(async (resolve, reject) => {
            ...
            .catch(err => {
                let er = new Error("Une erreur s'est produite lors de la requête - createinvites, channel11")
                er.content = err
                reject(er)
            })
            .then(datas => { return resolve(datas)})
    ...
    editpermissions(overwrites){
        return new Promise(async (resolve, reject) => {
            ...
            .catch(err => {
                let er = new Error("Une erreur s'est produite lors de la requête - editpermissions, channel11")
                er.content = err
                reject(er)
            })
            .then(datas => { return resolve(datas)})
    ...
    deletepermissions(overwrites){
        return new Promise(async (resolve, reject) => {
            ...
            .catch(err => {
                let er = new Error("Une erreur s'est produite lors de la requête - deletepermissions, channel11")
                er.content = err
                reject(er)
            })
            .then(datas => { return resolve(datas)})
    ...
    follownewsChannel(targetid){
        return new Promise(async (resolve, reject) => {
            ...
            .catch(err => {
                let er = new Error("Une erreur s'est produite lors de la requête - follownewschannel, channel11")
                er.content = err
                reject(er)
            })
            .then(datas => { return resolve(datas)})
    ...
    getpins(){
        return new Promise(async (resolve, reject) => {
            ...
            .catch(err => {
                let er = new Error("Une erreur s'est produite lors de la requête - getpins, channel11")
                er.content = err
                reject(er)
            })
            .then(datas => { return resolve(datas)})
    ...
    triggertyping(){
        return new Promise(async (resolve, reject) => {
            ...
            .catch(err => {
                let er = new Error("Une erreur s'est produite lors de la requête - triggertyping, channel11")
                er.content = err
                reject(er)
            })
            .then(datas => { return resolve(datas)})
