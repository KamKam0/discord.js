module.exports = async (bot, datas) => {
    ...
    bot.guilds = bot.guilds.__DeleteGuild(datas.id)
    bot.users.__DeleteUsers(guild.members.Map(users => { return {user: users.ID, guild: guild.id}}))
    bot.channels.__DeleteChannels(guild.channels.map(ch => ch.id))
